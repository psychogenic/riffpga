/*
 * psydmi.h, part of the riffpga project
 *
...
#ifndef CONFIG_DEFAULTS_PSYDMI_H_
#define CONFIG_DEFAULTS_PSYDMI_H_

#define BOARD_NAME		"PsyDMI"
...
#endif /* CONFIG_DEFAULTS_PSYDMI_H_ */
