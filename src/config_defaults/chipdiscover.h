/*
 * chipdiscover.h, part of the ASICSim2 project
 *
...
#ifndef CONFIG_DEFAULTS_CHIPDISCOVER_H_
#define CONFIG_DEFAULTS_CHIPDISCOVER_H_

#define BOARD_NAME          "ChipFoundry ChipDiscover"
...
#define PIN_RP_LED			11


#define PIN_FPGA_RESET		15
#define PIN_FPGA_SPI_MISO	4
#define PIN_FPGA_SPI_CS		5
#define PIN_FPGA_SPI_SCK	6
#define PIN_FPGA_SPI_MOSI	3
// define PIN_FPGA_PROG_DONE	16

#define PIN_AUTOCLOCK1		16
#define PIN_AUTOCLOCK2		11 /* NC/don't use */
...
#define MANAGEDPINS_PROJRESET_PIN		14
#define MANAGEDPINS_PROJRESET_INVERTED	1
...
#define USER_SWITCH_RESET_PIN		7
...
#define USER_SWITCH_CLOCK_PIN		0
#define USER_SWITCH_CLOCK_FUNCTION	0 /* 2 == Clocking, 0 == Not set*/
...
#define SYSTEM_INPUTS_IO_LIST				17,18,19,20,21,22,23,24
#define SYSTEM_INPUTS_ENABLE_PULLDOWN
...
#endif /* CONFIG_DEFAULTS_CHIPDISCOVER_H_ */
